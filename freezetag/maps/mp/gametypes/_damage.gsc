...
{	
	if ( !isReallyAlive( victim ) )
		return;
	if(isSubStr(sWeapon,"throwingknife") && victim.pers["team"] != eAttacker.pers["team"])
		maps\mp\gametypes\_rank::freezePlayer(victim,eAttacker);
	...
	maps\mp\gametypes\_rank::playerHit( eAttacker, victim, sWeapon, sMeansOfDeath );
}
